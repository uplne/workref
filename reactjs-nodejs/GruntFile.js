module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        */
        ...
        shell: {
            compileAmortizationCalc: {
                command: 'jspm bundle apps/amortization/amortization-schedule-calculator public/js/amortization/amortization-calculator-build.js -m --inject --no-mangle'
            }
        },
        ...
        */
        nodemon: {
            dev: {
                script: 'server/budgetlioweb.js',
                options: {
                    "execMap": {
                        "js": "NODE_ENV=dev npm run babel-node"
                    },
                    nodeArgs: ['--debug'],
                    ignore: ['<%= dir.jspublic %>'],
                    env: {
